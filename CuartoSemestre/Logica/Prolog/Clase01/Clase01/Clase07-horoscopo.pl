/* 
    ...
    Signo de personas nacidas entre  DiaIni/MesIni y el DiaFin/MesFin
 */
...
/* signo(DiaNAcimiento ,MesNacimiento ,SignoX) Si naciste en DiaNacimiento y MesNacimiento 
   perteneces al signo SignoX */
